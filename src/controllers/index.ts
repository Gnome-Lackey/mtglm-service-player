...
export const getSeasonMetadata = async (playerId: string, seasonId: string): Promise<LambdaResponse> => {
  try {
    const result = await service.getSeasonMetadata(playerId, seasonId);
